...
global.anitav4 = process.env.BOT_NAME || "Ezio-Md-V3";
global.ownername = process.env.OWNER_NAME || "Temp Ezio";
global.packname = process.env.PACK_NAME || "Ezio-Md-V3";
global.author = process.env.AUTHOR || "Temp Ezio";
global.channelname = process.env.CHANNEL_NAME || "Temp Ezio";
